...
# =========================================================
'''
Для устранения проблем совместимости версий python и nose,
нужно было внести данные изменения
'''
import collections
import collections.abc

# Monkey-patch для исправления nose в Python 3.10
if not hasattr(collections, 'Callable'):
    collections.Callable = collections.abc.Callable
    
# Также исправляем возможные проблемы с другими атрибутами
...
if __name__ == "__main__":
    # Запуск всех тестов через nose
    import sys
    sys.argv = ['nosetests', '-v'] + sys.argv[1:]
    nose.run()